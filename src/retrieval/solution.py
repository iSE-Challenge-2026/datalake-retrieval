"""Solution runner that exports retrieved source file paths."""
...
def run_retrieval_solution(
    ...
    *,
    ...
    for question in questions:
        ...
        source_files = [_absolute_source_path(result.source_path, source_root) for result in results]
        row: dict[str, Any] = {
        ...
        if resolved.include_details:
            row["top_results"] = [_result_payload(result, source_root) for result in results]
        rows.append(row)
