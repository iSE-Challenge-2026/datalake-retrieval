"""Run retrieval for a question file and export source paths."""
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run source retrieval and export local source file paths.")
    parser.add_argument("--questions", required=True, type=Path)
    parser.add_argument("--output", type=Path, default=OUTPUT_DIR / "retrieval_source_paths.json")
    parser.add_argument("--output-format", choices=["json", "csv"], default="json")
    parser.add_argument("--include-details", action="store_true")
    parser.add_argument("--build-first", action="store_true", help="Run ingestion/indexing before retrieval.")
